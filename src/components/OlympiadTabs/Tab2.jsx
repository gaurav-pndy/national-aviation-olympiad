      ...
      >
        ...
        <div className="bg-white p-4 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            Comprehensive guides tailored for each class (8–12), covering all
            exam topics.
          </p>
        </div>
        ...
        <div className="bg-white p-4 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            Expert-led sessions simplifying complex aviation concepts with
        ...
        <div className="bg-white p-4 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            Mock exams with detailed solutions and performance analytics to
            track progress.
          </p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="bg-white p-4 mb-4">
          ...
          <p className="text-gray-700">
            Build a strong understanding of aviation principles, basics, and
            terminology.{" "}
          </p>
        </div>
        <div className="bg-white p-4 mb-4">
          ...
          <p className="text-gray-700">
            Solve practical problems and case studies related to real aviation
            scenarios.
          </p>
        </div>
