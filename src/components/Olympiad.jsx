...
const zones = [
  ...
  },
  {
    label: "East Zone",
    states:
      "West Bengal, Odisha, Jharkhand, Bihar, Assam, Arunachal Pradesh, Manipur, Meghalaya, Mizoram, Nagaland, Tripura, Sikkim",
  },
  {
    label: "West Zone",
    states: "Maharashtra, Gujarat, Rajasthan, Madhya Pradesh, Goa",
  },
  {
    label: "UT Zone",
    states:
      "Ladakh, Jammu & Kashmir, Delhi, Chandigarh, Andaman & Nicobar Islands, Dadra & Nagar Haveli and Daman & Diu, Puducherry, Lakshadweep",
  },
];
    ...
    <section id="olympiad" className="py-16  bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-6 text-center mb-10">
        ...
        >
          ...
          Grades 8-12, across India. This comprehensive three stage competition
          evaluates students’ understanding of aviation principles and STEM
          general aviation knowledge through a structured and progressive
          examination system.
        </motion.p>
        {/* Tabs */}
